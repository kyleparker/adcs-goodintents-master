...
//        f.setArguments(args);
    ...
    private void setupView() {
        ...
        mDesc = (TextView) mRootView.findViewById(R.id.edit_event_date);
        mOrg = (TextView) mRootView.findViewById(R.id.edit_event_name);
        mDate = (TextView) mRootView.findViewById(R.id.edit_event_desc);
